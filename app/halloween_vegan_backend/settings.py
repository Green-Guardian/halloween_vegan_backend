"""
Django's settings for halloween_vegan_backend project.
...
STATIC_URL = '/halloween-vegan-backend-stage/static/'
STATICFILES_STORAGE = 'django.contrib.staticfiles.storage.ManifestStaticFilesStorage'
STATICFILES_DIRS = [BASE_DIR / 'static', ]
MEDIA_ROOT = BASE_DIR / 'media'
MEDIA_URL = '/halloween-vegan-backend-stage/media/'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-sdfSDFg7654#OWE$%^yhdjMHk)&^%@fghdsdfsdfHJSD')
...
WSGI_APPLICATION = 'app.halloween_vegan_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'halloween_vegan_backend'),
